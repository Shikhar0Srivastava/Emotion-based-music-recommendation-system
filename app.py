...
json_file = open("D:\\fyp\\newTrain\\emo.json", 'r')
loaded_model_json = json_file.read()
json_file.close()
model = model_from_json(loaded_model_json)

# Loading weights from pretrained model
model.load_weights("D:\\fyp\\newTrain\\emo.weights.h5")
    ...
    if st.button('SCAN EMOTION(Click here)'):
        ...
        while True:
            ...
            for (x, y, w, h) in faces:
                ...
                cv2.putText(frame, emotion_dict[max_index], (x + 20, y - 60), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2, cv2.LINE_AA)
